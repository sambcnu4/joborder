...
<div class="departments-index">
    ...
    <div class="actions-form">
        <div class="box box-success box-solid">
            ...
            <div class="box-body"> 
                <p>
                    <?= Html::a('เพิ่มหน่วยงาน', ['create'], ['class' => 'btn btn-danger']) ?>
                </p>
                ...
                GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'filter' => Html::activeDropDownList($searchModel, 'id', ArrayHelper::map(Departments::find()->all(), 'id', 'color'), ['class' => 'form-control', 'prompt' => 'ทั้งหมด...'])
                        ],
